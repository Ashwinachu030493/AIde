...
def build_enhanced_prompt(user_message: str, code_context: List[Any], 
    ...
    if code_context:
        ...
        for code in code_context:
            ...
            content = code.get('content') if isinstance(code, dict) else getattr(code, 'content', '')
            meta = code.get('metadata', {}) if isinstance(code, dict) else getattr(code, 'metadata', {})
