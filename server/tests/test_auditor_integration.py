...
from server.auditor.rules import AuditRule, Severity, ALL_RULES
...
"""
        ...
        todo_violations = [v for v in result.violations if 'TODO' in v.description or 'FIXME' in v.description]
...
class TestAuditRulesConfiguration:
    ...
    def test_security_rules_are_critical_or_warning(self):
        ...
        for rule in SECURITY_RULES:
            assert rule.severity in [Severity.CRITICAL, Severity.WARNING], \
