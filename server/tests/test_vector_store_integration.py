...
class TestVectorStoreInitialization:
    ...
    def test_timeout_triggers_fallback(self):
        ...
        with patch('server.shared.vector_store.embedding_functions.SentenceTransformerEmbeddingFunction') as mock_st:
...
class TestVectorStoreLazyLoading:
    ...
    def test_vector_store_initialized_on_first_use(self):
        ...
        from server.ingestion.router import get_vector_store, _vector_store
